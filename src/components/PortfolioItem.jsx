  ...
  return(
    <div className="border-2 border-stone-0000 rounded-md overflow-hidden ">
      ...
      <div className="w-full p-4">
        ...
        <a href={url}><button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Live Project</button></a>
      </div>
    </div>
